...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <h3 class="title-big text-center mb-md-5 mb-4">Order Details </h3>
      <form name="form1" method="post" action="">
        <table width="96%" height="98" border="2" align="center">
          <tr>
            <td><h4>ID</h4></td>
            <td><h4>FoodName</h4></td>
            <td><h4>Type</h4></td>
            <td><h4>Timing</h4></td>
            <td><h4>Quantity</h4></td>
            <td><h4>TotalPrice</h4></td>
            <td><h4>HolderName</h4></td>
            <td><h4>Delivery Address </h4></td>
            <td><h4>Pincode</h4></td>
            <td><h4>City</h4></td>
          </tr>
           <?php
	 $qq="Select * from user_booking";
