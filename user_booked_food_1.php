...
$food=$_REQUEST['food'];
  ...
  $qrys1="select * from  user_booking where id=$id";
...
$report=$row['report'];        
  ...
  ////////////////////////////////////////////////////////////////////////////
$sql = "SELECT * FROM add_food where hotel='$hotel' and foodname='$food'";

 $status=0;
  $result = $conn->query($sql);
  while($row1 = $result->fetch_assoc()) 
  {
        $old_status=$row1['status'];
  }
...
//////////////////////////////////////////////////////////////////////////// 
   ...
   if(isset($btn))
{
$quantity=$_REQUEST['feedback'];

///////////////////////////////////

$sql1 = "SELECT * FROM train_keywords";
$mark=0;
 $status=0;
  ...
  while($row11 = $result1->fetch_assoc()) 
  {
        ...
        $keywords=$row11['keywords'];
        $type=$row11['type'];
		if($type=="Positive")		
		{
	 
			if (strpos($quantity, $keywords) !== false) 
			{
    			$mark=$mark+1;
			}
		}
  ...
  $mark=$mark+$old_status;
$up_fees="update add_food set status='$mark' where hotel='$hotel' and foodname='$food'"; 
if($conn->query($up_fees) === TRUE){
}
///////////////////////////////////

$sql = "SELECT id FROM user_feedback order by id ASC";
 ...
 $sid=0;
  ...
  $qrys1="insert into user_feedback values($sid,'$report','$quantity', '0','$mark','$hotel')";
...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <h3 class="title-big text-center mb-md-5 mb-4">Add FeedBack </h3>
      <form name="form1" method="post" action="">
        <table width="346" height="167" border="0" align="center">
          <tr>
            <td width="121">User Name </td>
            <td width="208"><?php echo $report;?>&nbsp; </td>
          </tr>
          <tr>
            <td>FeedBack</td>
            <td><label>
