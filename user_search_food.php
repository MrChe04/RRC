...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <form name="form1" method="post" action="">
        <table width="290" height="81" border="0" align="center">
          <tr>
            <td>Food Name </td>
            <td><label>
              <input name="foodname" type="text" id="foodname"  placeholder="FoodName" required=""
            </label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <table width="994" height="127" border="2" align="center">
          <tr>
            <td width="34"><h4>ID</h4></td>
            <td width="102"><h4>Hotel</h4></td>
            <td width="102"><h4>FoodName</h4></td>
            <td width="101"><h4>Type</h4></td>
            <td width="106"><h4>Timing </h4></td>
            <td width="111"><h4>FoodType</h4></td>
            <td width="78"><h4>Price</h4></td>
            <td width="67"><h4>GST</h4></td>
            <td width="153"><h4>Image</h4></td>
            <td width="98">&nbsp;</td>
          </tr>
                          <?php
	 $qq="Select * from add_food where foodname='$foodname' order by status DESC";
     ...
     <tr>
       ...
       <td><a href="user_search_food_1.php?id=<?php echo $row['id'];?>">Click...</a></td>
     </tr>
	 <?php
	 }
	 ?>
