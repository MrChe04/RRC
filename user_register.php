...
$sql = "SELECT id FROM user_register order by  id ASC";
...
while($row = $result->fetch_assoc())
{
  ...
  $qq="insert into user_register values('$sid','$sname','$contact','$address','$gender','$mail','$uname','$pass','0','0')";
...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <h3 class="title-big text-center mb-md-5 mb-4">User Register </h3>
        <form name="form1" method="post" action=""> 
          <table width="421" height="252" border="0" align="center">
            <tr>
              <td>Name</td>
              <td><label>
