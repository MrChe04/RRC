...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <h3 class="title-big text-center mb-md-5 mb-4">Booked Food </h3>
      <form name="form1" method="post" action="">
        <table width="95%" height="90" border="2" align="center">
          <tr>
            <td><h4>ID</h4></td>
            ...
            <td><h4>FeedBack</h4></td>
                  ...
                  <?php
	 $qq="Select * from user_booking where report='$username'";
     ...
     <tr>
       ...
       <td><a href="user_booked_food_1.php?id=<?php echo $row['id'];?>&hotel=<?php echo $row['hotel'];?>&food=<?php echo $row['foodname'];?>">Click...</a></td>
     </tr>
	 <?php
	 }
	 ?>
