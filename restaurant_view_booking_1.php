...
while($row = $result->fetch_assoc())
{
 ...
 $delivery=$row['delivery'];  
   ...
   if(isset($btn))
{
$packed=$_REQUEST['packed'];
 

$sql = "SELECT id FROM delivery_details order by id ASC";
 ...
 echo $qrys1="insert into delivery_details values($sid,'$report','$delivery', '$packed','0','0')";
...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <h3 class="title-big text-center mb-md-5 mb-4">Food Delivery  </h3>
      <form name="form1" method="post" action="">
        <table width="406" height="127" border="0" align="center">
          <tr>
            <td>Delivery To </td>
          ...
          <tr>
            <td>Packed On </td>
            <td><label>
              <input name="packed" type="date" id="packed" required="" placeholder="Packed On">
            </label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label>
              <input name="btn" type="submit" id="btn" value="Shipping">
            </label></td>
          </tr>
        </table>
      </form>
