...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <h3 class="title-big text-center mb-md-5 mb-4">View Booking </h3>
      <form name="form1" method="post" action="">
        <table width="95%" height="69" border="2" align="center">
          <tr>
            <td>ID</td>
            <td>FoodName</td>
            <td>Type</td>
     ...
     <tr>
       ...
       <td><?php echo $row['city'];?></td>
	      <td><a href="restaurant_view_booking_1.php?id=<?php echo $row['id'];?>">Click...</a></td>
     </tr>
	 <?php
	 }
	 ?>
