...
<section class="w3l-team section py-5" id="team">
  <div class="container py-lg-5 py-md-4">
      ...
      <h3 class="title-big text-center mb-md-5 mb-4">Delivery Details </h3>
      <form name="form1" method="post" action="">
        <table width="50%" height="64" border="2" align="center">
          <tr>
            <td>ID</td>
            <td>Delivery To </td>
            <td>Address</td>
           ...
           <?php
	 $qq="Select * from delivery_details";
     ...
     <tr>
       ...
       <td><?php echo $row['deliveryto'];?></td>
       <td><?php echo $row['address'];?></td>
       <td><?php echo $row['packedon'];?></td>
